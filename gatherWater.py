...
matchValue = 'Safely managed drinking water sources, urban (Proportion of population with access)'
newSpreadSheet = 'otherStatsWater.xlsx'
...
def openOther():
    wb = load_workbook('./data/UNWater001.xlsx')
    return wb
